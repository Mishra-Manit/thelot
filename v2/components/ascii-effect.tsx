...
// Module-level state shared with the Effect instance update loop
let _time = 0
...
class AsciiEffectImpl extends Effect {
  constructor(options: AsciiEffectOptions) {
    ...
    super("AsciiEffect", fragmentShader, {
      ...
      // Postprocessing types uniforms as Map<string, Uniform<number>> but we need mixed value types
      ...
      ]) as unknown as Map<string, Uniform<number>>,
    })
